...
import com.rentals.dtos.ProfilePinStatusDTO;
...
import com.rentals.services.ProfilePinStatusService;
...
public class Controller {
	...
	@Autowired
	ProfilePinStatusService profilePinStatusService;
	@Autowired
	...
	//Profile Pin Status end points 
	
	@GetMapping("/profilePinStatus/fetch")
	public List<ProfilePinStatusEntity> getAllProfilePinStatuses() {
		return profilePinStatusService.getAllProfilePinStatuses();
	}
	
	@PostMapping("/profilePinStatus/create")
	public List<ProfilePinStatusEntity> addProfilePinStatus(@RequestBody ProfilePinStatusDTO profilePinStatusDTO) throws JsonProcessingException {
		logger.info("Received ProfilePinStatus Details ::{}",objectMapper.writeValueAsString(profilePinStatusDTO));
		//Map ProfilePinStatus DTO to ProfilePinStatus Entity
		ProfilePinStatusEntity profilePinStatusEntity = modelMapper.map(profilePinStatusDTO, ProfilePinStatusEntity.class);
		logger.info("Mapped ProfilePinStatus Entity ::{}",objectMapper.writeValueAsString(profilePinStatusEntity));
		profilePinStatusService.addProfilePinStatus(profilePinStatusEntity);
		return profilePinStatusService.getAllProfilePinStatuses();
	}
